...
class LogicalDetectionData final :
 ...
 public:
  ...
  inline LogicalDetectionData* New() const final {
    return new LogicalDetectionData();
  }
  ...
  PROTOBUF_MUST_USE_RESULT ::osi3::LogicalDetectionDataHeader* release_header();
...
class LogicalDetectionDataHeader final :
 ...
 public:
  ...
  inline LogicalDetectionDataHeader* New() const final {
    return new LogicalDetectionDataHeader();
  }
  ...
  PROTOBUF_MUST_USE_RESULT ::osi3::Timestamp* release_logical_detection_time();
...
class LogicalDetection final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::osi3::Vector3d* release_position_rmse();
  ...
  PROTOBUF_MUST_USE_RESULT ::osi3::Vector3d* release_velocity_rmse();
...
inline void LogicalDetectionData::set_allocated_header(::osi3::LogicalDetectionDataHeader* header) {
  ...
  if (header) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::osi3::LogicalDetectionDataHeader>::GetOwningArena(header);
    if (message_arena != submessage_arena) {
