...
class EnvironmentalConditions_TimeOfDay final :
 ...
 public:
  ...
  inline EnvironmentalConditions_TimeOfDay* New() const final {
    return new EnvironmentalConditions_TimeOfDay();
  }
...
class EnvironmentalConditions final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::osi3::EnvironmentalConditions_TimeOfDay* release_time_of_day();
...
inline void EnvironmentalConditions::set_allocated_time_of_day(::osi3::EnvironmentalConditions_TimeOfDay* time_of_day) {
  ...
  if (time_of_day) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::osi3::EnvironmentalConditions_TimeOfDay>::GetOwningArena(time_of_day);
