...
class RoadMarking_Classification final :
 ...
 public:
  ...
  inline RoadMarking_Classification* New() const final {
    return new RoadMarking_Classification();
  }
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_value_text();
...
class RoadMarking final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::osi3::RoadMarking_Classification* release_classification();
...
void RoadMarking_Classification::set_value_text(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 value_text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RoadMarking_Classification::_internal_set_value_text(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  value_text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* RoadMarking_Classification::_internal_mutable_value_text() {
  _has_bits_[0] |= 0x00000001u;
  return value_text_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* RoadMarking_Classification::release_value_text() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return value_text_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline void RoadMarking::set_allocated_classification(::osi3::RoadMarking_Classification* classification) {
  ...
  if (classification) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::osi3::RoadMarking_Classification>::GetOwningArena(classification);
    if (message_arena != submessage_arena) {
