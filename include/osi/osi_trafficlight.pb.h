...
class TrafficLight_Classification final :
 ...
 public:
  ...
  inline TrafficLight_Classification* New() const final {
    return new TrafficLight_Classification();
  }
...
class TrafficLight final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::osi3::TrafficLight_Classification* release_classification();
...
inline void TrafficLight::set_allocated_classification(::osi3::TrafficLight_Classification* classification) {
  ...
  if (classification) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::osi3::TrafficLight_Classification>::GetOwningArena(classification);
    if (message_arena != submessage_arena) {
